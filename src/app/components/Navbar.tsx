...
const navigation = [
  ...
  { name: "text generation (t.b.a)", href: "#", current: false },
  { name: "agent workflow (t.b.a)", href: "#", current: false },
];
      ...
      {({ open }) => (
        <>
          <div className="mx-auto px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center flex-start">
                      ...
                      <a
                        ...
                        className={classNames(
                          item.current
                            ...
                            : "text-gray-500 hover:bg-200-700 hover:text-black",
